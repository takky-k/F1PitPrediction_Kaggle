...
def add_engineered_features(train: pd.DataFrame, test: pd.DataFrame) -> Tuple[pd.DataFrame, pd.DataFrame, List[str], List[str], List[str]]:
    ...
    freq_cols = ["Driver", "RaceKey", "CompoundNorm", "StintBin", "RaceYear", "DriverRace", "TrackType", "CircuitCountry", "TyreLifeBin", "RaceProgress_Bin"]
    for c in freq_cols:
        if c in all_df.columns:
    ...
    categorical_features = [
        ...
        "StintBin", "RaceYear", "DriverRace", "DriverYear", "RaceProgress_Bin", "TyreLifeBin", "LapNumberBin", "PositionBin", "CircuitLengthBin", "DataSource"
    ]
